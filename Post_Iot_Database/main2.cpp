...
#define WIFI2_SSID "PURI DEWATA"
#define WIFI2_PASSWORD "googletranslate"
...
const char* serverNameTurbi = "https://rewanaweb.com/IoT-Test/xxx.php";
const char* serverNameFlow = "https://rewanaweb.com/IoT-Test/xxx.php";
...
String apiKeyValueTurbi = "xxx";
String apiKeyValueFlow= "xxx";
...
void connectToWifi() {
    const char* ssid[] = {WIFI1_SSID, WIFI2_SSID, WIFI3_SSID};
...
void postdataFlow(){
  ...
  if(WiFi.status() == WL_CONNECTED){
    ...
    String httpRequestDataFlowHulu = "api_key=" + apiKeyValueFlow + "&sensor=" + sensorFlowHulu
                          + "&location=" + sensorLocHulu + "&flowrate=" + String(FlowRateHulu) +
                          + "&debit=" + String(testFlowmiliLiterHulu);
    Serial.print("httpRequestDataFlowHulu: ");
    Serial.println(httpRequestDataFlowHulu);
    ...
    testFlowmiliLiterHulu+=1;
    testtotalMiliLiterHilir+=1;
